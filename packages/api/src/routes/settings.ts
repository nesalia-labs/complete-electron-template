...
import { z } from 'zod'
import { settingsRegistry, type SettingDefinition } from '../settings/index.js'
 ...
 */
export function createSettingsRoutes(store: AppStore) {
...
// Re-export SettingDefinition for downstream consumers (electron-store wiring).
